...
const fadeElements = document.querySelectorAll('.service-card, .achievement-card, .partner-card, .consult-card, .contact-card');
...
// 5. تأثير 3D للبطاقات
const cards = document.querySelectorAll('.service-card, .achievement-card, .partner-card, .contact-card');
cards.forEach(card => {
